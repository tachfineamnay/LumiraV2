...
| Routage IA historique                                  | `AiRoutingRuleLegacy`                                           | Archive non opérationnelle, préservée pour rollback ; `MODEL_CONFIG` pilote désormais toutes les exécutions.                                    | Aucune règle historique ne doit être réactivée dans le runtime.                                                                                                                        | Historique | Migration réversible documentée.                                                                    |
