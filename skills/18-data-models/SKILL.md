...
model UserProfile {
  ...
  pace             Int?
  preferredVoice   AudioVoice?  @default(FEMININE)  // TTS voice preference
...
enum FileType {
  FACE_PHOTO
  PALM_PHOTO
  AUDIO_READING   // Generated TTS audio file
}
```
...
model Insight {
  ...
  audioUrl    String?         // TTS audio URL (S3) — generated by AudioGenerationService
