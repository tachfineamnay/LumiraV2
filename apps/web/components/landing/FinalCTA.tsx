        ...
        <section className="relative py-40 overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                ...
                <motion.h2
                    ...
                    className="font-playfair italic text-5xl md:text-7xl text-white leading-[1.05] mb-8"
                >
                    Êtes-vous prêt à{' '}
                ...
                <motion.p
                    ...
                    className="text-white/60 text-lg font-light leading-relaxed max-w-2xl mx-auto mb-16"
                >
                ...
                >
                    <Link
                        href="/commande"
                        className="group relative inline-flex items-center gap-4 px-12 py-6 rounded-2xl text-abyss-900 font-bold text-lg overflow-hidden"
                        style={{
