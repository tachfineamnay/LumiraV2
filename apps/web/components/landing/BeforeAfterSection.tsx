...
const TRANSFORMATIONS = [
    {
        ...
        after: 'J\'ai compris que ma "dispersion" était en réalité ma plus grande force : je suis née pour explorer, pas pour me fixer.',
        name: 'Camille, 31 ans',
    ...
    },
    {
        ...
        after: 'La lecture a révélé mon schéma de don excessif. Aujourd\'hui j\'attire des personnes qui me voient vraiment.',
        name: 'Yasmine, 28 ans',
    ...
    },
    {
        ...
        after: 'L\'Oracle a identifié une blessure de légitimité profonde. Depuis, j\'ai lancé mon entreprise.',
        name: 'David, 36 ans',
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-12">
                ...
                <div className="mb-20">
                    ...
                    <p className="text-white/40 mt-6 max-w-lg text-base font-light leading-relaxed">
                        Une lecture Lumira ne donne pas des réponses génériques.
                        Elle met des mots précis sur ce que vous vivez — et ouvre le chemin vers ce que vous désirez vraiment.
                    </p>
                </div>
                ...
                <div className="space-y-6">
                    {TRANSFORMATIONS.map((item, i) => (
                        ...
                        >
                            {/* AVANT */}
                            <div className="bg-white/[0.02] p-10 md:p-14 relative">
                            ...
                            {/* APRÈS */}
                            <div className="bg-gradient-to-br from-amber-500/[0.06] to-purple-900/[0.06] p-10 md:p-14 relative border-l border-amber-500/10">
                                ...
                                <div className="mt-8 flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-white/30 text-xs mt-1 uppercase tracking-widest">{item.domain}</div>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
