...
export function Footer() {
  ...
  return (
    <footer className="relative bg-void border-t border-white/5 pt-16 md:pt-32 pb-12 overflow-hidden content-visibility-auto">
      <div className="absolute inset-0 bg-noise opacity-20 pointer-events-none" />

      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 lg:gap-24 mb-12 md:mb-24">
          ...
          <div>
            <span className="text-white/20 text-[10px] uppercase tracking-[0.2em] font-bold block mb-8">
              Navigation
            </span>
