...
export function TimelineConstellation({
    ...
    const daySlots: Array<{ day: number; step: PathStep | null; state: 'completed' | 'active' | 'locked' | 'pending' }> = [];
        ...
        <div className="relative min-h-[600px]">
                ...
                <div className="space-y-8">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="absolute left-1/2 transform -translate-x-1/2 z-10">
                                    <StarNode
                                        state={isPending ? 'pending' : state === 'active' ? 'active' : state === 'completed' ? 'completed' : 'locked'}
                                        dayNumber={day}
                    ...
                    ${isPending
                                            ...
                                            : isLocked
                                                ...
                                                : isInteractive
                                                    ? isActive
                                                        ? 'bg-gradient-to-br from-amber-500/20 to-amber-600/10 border border-amber-500/30 hover:border-amber-400/50 cursor-pointer'
                                                        : 'bg-slate-800/60 border border-slate-700/50 hover:border-amber-500/30 cursor-pointer'
                                ...
                                >
                                    {isPending ? (
                                        <div className="text-center py-1">
                                            <span className="text-xs text-slate-500">Jour {day}</span>
                                            <p className="text-xs text-slate-600 italic mt-0.5">En attente de canalisation</p>
                                        </div>
                                    ) : step ? (
                                        <>
                                        ...
                                        <div className="text-center py-1">
                                            <span className="text-xs text-slate-500">Jour {day}</span>
                                            <p className="text-xs text-slate-600 italic mt-0.5">Verrouillé</p>
                                        </div>
                                    )}
                                </motion.div>
                            </motion.div>
            ...
            {onOpenChat && (
                <motion.button
                    ...
                    onClick={onOpenChat}
                    className="fixed right-6 bottom-[calc(var(--sanctuaire-bottom-nav-h)+1rem)] lg:bottom-6 w-14 h-14 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 text-slate-900 shadow-xl shadow-amber-500/30 flex items-center justify-center hover:from-amber-400 hover:to-amber-500 transition-colors z-[45]"
      ...
      `}
        >
            ...
            {isCompleted ? (
                ...
                <span className="text-xs text-slate-600">{dayNumber}</span>
            ) : isLocked ? (
