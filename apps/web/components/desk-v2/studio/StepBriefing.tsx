    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <p className="text-desk-muted mb-2">
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              <div className="bg-desk-card border border-desk-border rounded-xl p-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-semibold text-desk-text">{user.firstName} {user.lastName}</p>
                ...
                <div className="space-y-2.5 text-sm">
                  {profile?.birthDate && (
                    <div className="flex items-center gap-2 text-desk-muted">
                      ...
                      {profile?.birthTime && <span className="text-desk-subtle">à {profile.birthTime}</span>}
                    </div>
                  )}
                  {profile?.birthPlace && (
                    <div className="flex items-center gap-2 text-desk-muted">
              ...
              {profile?.specificQuestion && (
                <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-semibold text-purple-600 uppercase tracking-wider">Question</span>
                  </div>
              ...
              {profile?.objective && (
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-semibold text-blue-600 uppercase tracking-wider">Objectif</span>
                  </div>
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-xs">
                  <span className={expertPrompt.length < 10 ? 'text-desk-subtle' : 'text-emerald-600'}>
