        ...
        <div className="card-premium p-6 md:p-8">
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div className="relative">
              ...
              {/* Status indicator */}
              <div
                className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full border-2 border-abyss-700 flex items-center justify-center ${profileComplete ? 'bg-emerald-500' : 'bg-amber-500'}`}
              >
                {profileComplete ? (
