  ...
  if (!data?.hasSubscription || !data.subscription) {
    return (
      <div className="max-w-lg mx-auto px-3 sm:px-6 py-8 sm:py-12 text-center">
        ...
        <h1 className="text-2xl font-playfair italic text-white mb-3">Aucun abonnement actif</h1>
          ...
          <div className="flex gap-3">
            {isCancelPending ? (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-5 py-3 min-h-[48px] rounded-xl bg-gradient-to-r from-serenity-500 to-serenity-600 text-white font-semibold hover:from-serenity-400 hover:to-serenity-500 disabled:opacity-50 transition-all"
              >
              ...
              <button
                ...
                disabled={!!actionLoading}
                className="flex-1 flex items-center justify-center gap-2 px-5 py-3 min-h-[48px] rounded-xl bg-white/5 border border-white/10 text-stellar-400 hover:bg-white/10 hover:text-stellar-300 disabled:opacity-50 transition-all text-sm"
              >
      ...
      <AnimatePresence>
        {showConfirm && (
          ...
          >
            ...
            >
              <h3 className="text-lg font-semibold text-white mb-3">Confirmer l&apos;annulation</h3>
              <p className="text-sm text-stellar-400 mb-6">
                Vous conserverez l&apos;accès jusqu&apos;au {formatDate(sub.currentPeriodEnd)}. Vous
                pourrez toujours reprendre votre abonnement avant cette date.
              </p>
              <div className="flex gap-3">
                <button
                  onClick={() => setShowConfirm(false)}
