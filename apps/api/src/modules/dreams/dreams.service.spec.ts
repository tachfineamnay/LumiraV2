...
describe('DreamsService', () => {
  ...
  const mockInterpretation = {
    symbols: ['forêt', 'lumière'],
    interpretation: 'Un rêve de paix intérieure',
    linkToReading: 'Votre lecture met en lumière ce besoin de paix.',
    linkToToday: 'Prenez un moment dans la nature aujourd’hui.',
    advice: 'Connecte-toi à la nature',
    pattern: null,
  };
